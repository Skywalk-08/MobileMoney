...
<div class="page-header">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Retrait</li>
        </ol>
    </nav>
</div>
        ...
        <div class="card">
            <div class="card-body p-4">
                <div class="d-flex align-items-center gap-2 mb-4">
                    <div class="rounded-circle d-flex align-items-center justify-content-center" style="width: 40px; height: 40px; background: rgba(214, 137, 16, 0.1);">
                        <i class="bi bi-cash" style="color: var(--warning); font-size: 1.2rem;"></i>
                    </div>
                    <h3 class="mb-0 fw-bold">Retrait</h3>
                </div>
                ...
                <form action="/client/retrait/store" method="post">
                    ...
                    <div class="d-grid gap-2">
                        <button type="submit" class="btn btn-warning-custom btn-lg">
                            <i class="bi bi-check-lg me-2"></i>Confirmer le retrait
                        </button>
